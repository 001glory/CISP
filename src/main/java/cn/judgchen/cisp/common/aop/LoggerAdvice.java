...
public class LoggerAdvice {
	...
	@Before("within(cn.judgchen.cisp..*) && @annotation(loggerManage)")
	...
	@AfterReturning("within(cn.judgchen.cisp..*) && @annotation(loggerManage)")
	public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
		logger.info("执行 " + loggerManage.description() + " 结束");
	}
	
	@AfterThrowing(pointcut = "within(cn.judgchen.cisp..*) && @annotation(loggerManage)", throwing = "ex")
